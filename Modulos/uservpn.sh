...
fun_edithost () {
  clear
  echo -e "\E[44;1;37m          GANTI OVPN HOST            \E[0m"
  echo ""
  echo -e "\033[1;33mHOST EM USO\033[1;37m: \033[1;32m$Host"
  echo ""
  echo -e "\033[1;31m[\033[1;36m1\033[1;31m] \033[1;33mRECHARGE LANGSUNG"
  ...
  echo -e "\033[1;31m[\033[1;36m0\033[1;31m] \033[1;33mKEMBALI"
  echo ""
  echo -ne "\033[1;32mHOST YANG INGIN DIGGUNAKAN \033[1;33m?\033[1;37m "; read respo
  if [[ -z "$respo" ]]; then
    echo ""
    echo -e "\033[1;31mOpsi tidak valida!"
    sleep 2
    fun_edithost
  fi
  if [[ "$respo" = '1' ]]; then
    echo ""
    echo -e "\033[1;32mMENGUBAH HOST!\033[0m"
    echo ""
    fun_althost () {
        sed -i "s;$rmt;remote $rmt3 $_Port;" $cert01
        sed -i "s;$hedr;http-proxy-option CUSTOM-HEADER Host $vivo1;" $cert01
        sed -i "s;$prxy;http-proxy $IP 80;" $cert01
    }
    fun_bar 'fun_althost'
    echo ""
    echo -e "\033[1;32mHOST SUKSES!\033[0m"
    fun_geraovpn
    sleep 1.5
  elif [[ "$respo" = '2' ]]; then
    echo ""
    ...
    echo ""
    echo -e "\033[1;32mMENGUBAH FILE OVPN!\033[0m"
    echo ""
    echo -e "\033[1;31mPERHATIAN!\033[0m"
    echo ""
    echo -e "\033[1;33mUNTUK MENGHEMAT PENGGUNAAN KUNCI \033[1;32mctrl x y\033[0m"
    sleep 4
    clear
    nano /etc/openvpn/client-common.txt
    echo ""
    echo -e "\033[1;32mBERUBAH SUKSES!\033[0m"
    fun_geraovpn
    sleep 1.5
  elif [[ "$respo" = '0' ]]; then
    echo ""
...
then
  tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Pengguna ini sudah ada. coba nama lain." ; echo "" ; tput sgr0
  exit 1  
else
  if (echo $username | egrep [^a-zA-Z0-9.-_] &> /dev/null)
  then
    tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda memasukkan nama pengguna yang tidak valid!" ; tput setab 1 ; echo "Use apenas letras, números, pontos e traços." ; tput setab 4 ; echo "Não use espaços, acentos ou caracteres especiais!" ; echo "" ; tput sgr0
    exit 1
  else
    sizemin=$(echo ${#username})
    if [[ $sizemin -lt 2 ]]
    then
      tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda memasukkan nama pengguna yang sangat singkat," ; echo "use no mínimo dois caracteres!" ; echo "" ; tput sgr0
      exit 1
    else
      sizemax=$(echo ${#username})
      if [[ $sizemax -gt 10 ]]
      then
        tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda memasukkan nama pengguna yang sangat panjang," ; echo "use no máximo 10 caracteres!" ; echo "" ; tput sgr0
        exit 1
      else
        if [[ -z $username ]]
        then
          tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda memasukkan nama pengguna yang kosong!" ; echo "" ; tput sgr0
          exit 1
        else  
           echo -ne "\033[1;32mPassword:\033[1;37m "; read password
          if [[ -z $password ]]
          then
            tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda telah memasukkan kata sandi kosong!" ; echo "" ; tput sgr0
            exit 1
          else
            ...
            then
              ...
              then
                ...
                if [[ -z $dias ]]
                then
                  tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda meninggalkan jumlah hari agar akun kedaluwarsa kosong!" ; echo "" ; tput sgr0
                  exit 1
                else  
                  if [[ $dias -lt 1 ]]
                  then
                    tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda harus memasukkan beberapa hari lebih besar dari nol!" ; echo "" ; tput sgr0
                    exit 1
                  else
                      echo -ne "\033[1;32mBatas Limit Koneksi:\033[1;37m "; read sshlimiter
                    if (echo $sshlimiter | egrep '[^0-9]' &> /dev/null)
                    then
                      tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda memasukkan nomor limit koneksi yang tidak valid!" ; echo "" ; tput sgr0
                      exit 1
                    else
                      if [[ -z $sshlimiter ]]
                      then
                        tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Anda membiarkan limit koneksi kosong!" ; echo "" ; tput sgr0
                        exit 1
                      else
                        if [[ $sshlimiter -lt 1 ]]
                        then
                          tput setaf 7 ; tput setab 4 ; tput bold ; echo "" ; echo "Jumlah limit koneksi harus lebih besar dari nol!" ; echo "" ; tput sgr0
                          exit 1
                        else
                          ...
                          if [[ -e /etc/openvpn/server.conf ]]; then
                              ...
                              if [[ "$resp" = @(y|y) ]]; then
                                ...
                                clear
                                echo -e "\E[44;1;37m       AKUN BERHASIL DI BUAT !      \E[0m"
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP: \033[1;37m$IP" ; echo -e "\033[1;32mUser Name: \033[1;37m$username" ; echo -e "\033[1;32mPassword: \033[1;37m$password" ; echo -e "\033[1;32mKadaluarsa dalam: \033[1;37m$gui" ; echo -e "\033[1;32mBatas koneksi: \033[1;37m$sshlimiter" ; echo "" || echo "Tidak dapat membuat akun!" ; tput sgr0
                                sleep 1
                                function aguarde {
                                  helice () {
                                  ...
                                  echo -ne "\033[1;31mMENCIPTAKAN OVPN\033[1;33m.\033[1;31m. \033[1;32m"
                                  helice
                                  echo -e "\e[1DOK"
                                }
                                aguarde
                                ...
                                if [ -d /var/www/html/openvpn ]; then
                                  ...
                                  echo -e "\033[1;32mDtersedia di\033[1;31m" ~/"$username.zip\033[0m"
                                  sleep 1
                                fi
                              else
                                clear
                                echo -e "\E[44;1;37m       AKUN BERHASIL DI BUAT  !      \E[0m"
                                [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP: \033[1;37m$IP" ; echo -e "\033[1;32mUser Name: \033[1;37m$username" ; echo -e "\033[1;32mPassword: \033[1;37m$password" ; echo -e "\033[1;32mKadaluarsa dalam: \033[1;37m$gui" ; echo -e "\033[1;32mBatas koneksi: \033[1;37m$sshlimiter" ; echo "" || echo "Pengguna tidak dapat dibuat!" ; tput sgr0
                              fi
                          else
                            clear
                            echo -e "\E[44;1;37m       AKUN BERHASIL DI BUAT !      \E[0m"
                            [ $? -eq 0 ] && tput setaf 2 ; tput bold ; echo ""; echo -e "\033[1;32mIP: \033[1;37m$IP" ; echo -e "\033[1;32mUser Name: \033[1;37m$username" ; echo -e "\033[1;32mPassword: \033[1;37m$password" ; echo -e "\033[1;32mKadaluarsa dalam: \033[1;37m$gui" ; echo -e "\033[1;32mBatas koneksi: \033[1;37m$sshlimiter" ; echo "" || echo "Nama pengguna tidak dapat dibuat!" ; tput sgr0
                          fi
                        fi
                      fi
                    fi

...
fun_spn1 () {
	...
	echo -ne "\033[1;31mMENGHAPUS FIREWALL\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
read -p "$(echo -e "\033[1;32mINGIN MENGHAPUS ATURAN FIREWALL? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
	echo ""	
	fun_spn1
	echo ""
	echo -e "\033[1;33mTORRENT DI IJINKAN !\033[0m"
	echo ""
	echo -e "\033[1;32mFIREWALL berhasil dihapus !"
	echo ""
	if [[ -e /etc/openvpn/openvpn-status.log ]]; then
		echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m KEMBALIKAN SISTEM UNTUK SELESAI"
		echo ""
		read -p "$(echo -e "\033[1;32mRESTART SEKARANG \033[1;31m? \033[1;33m[s/n]:\033[1;37m ")" -e -i s respost
		echo ""
		if [[ "$respost" = 's' ]]; then
			echo -ne "\033[1;31mMulai kembali" 
...
echo -e "\033[1;31m[\033[1;33m!\033[1;31m]\033[1;33m FUNGSI BETA BERLAKU PADA RISIKO ANDA SENDIRI"
echo ""
read -p "$(echo -ne "\033[1;32mANDA INGIN MENDAFTAR ATURAN FIREWALL ? \033[1;33m[s/n]:\033[1;37m") " -e -i n resp
if [[ "$resp" = 's' ]]; then
echo ""
echo -ne "\033[1;33mUNTUK LANJUTKAN KONFIRMASI IP ANDA: \033[1;37m"; read -e -i $IP IP
if [[ -z "$IP" ]];then
echo ""
echo -e "\033[1;31mIP tidak valid\033[1;32m"
sleep 1
echo ""
read -p "Masukkan IP Anda: " IP
fi
echo ""
sleep 1
fun_fireon () {
...
fun_spn2 () {
	...
	echo -ne "\033[1;32mMENERAPKAN FIREWALL\033[1;32m.\033[1;33m.\033[1;31m. \033[1;32m"
	helice
	echo -e "\e[1DOk"
}
fun_spn2
echo ""
echo -e "\033[1;33mBLOCK\033[1;37m TORRENT \033[1;33m DI TERAPKAN !\033[0m"
echo ""
echo -e "\033[1;32mFIREWALL DITERAPKAN SECARA SUKSES!"
sleep 3
menu
else
	sleep 1

#!/bin/bash
clear
echo -e "\E[44;1;37m Username         Password       limit      valid \E[0m"
echo ""
...
then
data="\033[1;33mTidak pernah\033[0m"
else
    databr="$(date -d "$datauser" +"%Y%m%d")"
    hoje="$(date -d today +"%Y%m%d")"
    if [ $hoje -ge $databr ]
    then
    data="\033[1;31mTIDAK\033[0m"
    else
    dat="$(date -d"$datauser" '+%Y-%m-%d')"
    data=$(echo -e "$((($(date -ud $dat +%s)-$(date -ud $(date +%Y-%m-%d) +%s))/86400)) \033[1;37mHari\033[0m")
    fi
fi
...
Data=$(printf '%-1s' "$data")
echo -e "\033[1;33m$User \033[1;37m$Password \033[1;37m$Limit \033[1;32m$Data\033[0m"
...
echo -e "\033[1;33m• \033[1;36mTOTAL USER\033[1;37m $_tuser \033[1;33m• \033[1;32mONLINE\033[1;37m: $_onli \033[1;33m• \033[1;31mEXPIRED\033[1;37m: $_expuser \033[1;33m•\033[0m"
